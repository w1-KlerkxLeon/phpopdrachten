...
<main id="wrapper">
    ...
    <h2>
      ...
      <?php
        ...
        elseif($ambulanceComing == true && $trafficLightColor == "rood")
        {
            $driveOn = false;
        }
        //Ambulance komt of oranje stoplicht = stoppen
        elseif($ambulanceComing == true && $trafficLightColor == "oranje")
        {
            $driveOn = false;
        }
        ...
        elseif($ambulanceComing == false && $trafficLightColor == "rood")
        {
            $driveOn = false;
        }
        //Ambulance komt niet en oranje stoplicht = stoppen
        elseif($ambulanceComing == false && $trafficLightColor == "oranje")
        {
            $driveOn = false;
        }
        ...
        elseif($countryName == "Zweden" && $currentAge >= 18 && $currentAge <= 19)
        {
